...
export const NavBar = ({ onSearchKeyChange, onLanguageChange , currentLanguage }) => {
        ...
        <div className='menu-holder'>
          ...
          <nav className='menu-items'>
            ...
            <div className='menu-actions'>
              ...
              <I18nSelect currentLanguage={currentLanguage} onLanguageChange={onLanguageChange}></I18nSelect>
            </div>
          </nav>
        </div>
      </div>
